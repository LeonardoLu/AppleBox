...
extension PlaygroundBook {
    class Manifest: File_Plist {
        ...
        /// 一个字符串，用来从其他 **PlaygroundBook** 之中识别这本 Book 和作者。
        ///
        ...
        /// 一个字符串，指定这个 **PlaygroundBook** 的最低支持的 iOS 版本。
        ///
        ...
        /// 一个语言标识符，指定 **PlaygroundBook** 的默认语言和地区。
        ///
        ...
        /// 一个字符串，包含对 `.png` 文件的引用地址，该文件储存在和该文件同目录下的名为 `Resource` 的文件夹中，该文件将作为 **PlaygroundBook** 的封面使用。
        ///
        ...
        /// 一个字符串，提供 **PlaygroundBook** 的名称。
        ///
        /// 这个名称会显示在 Swift Playground App 中呈现给用户。
        ///
        /// 必须填写。
        let Name: String = "MyBook"

        /// 一个字符串，描述了 **PlaygroundBook** 的书本格式（Swift Playground book format）。例如：7.0
        ///
        /// 必须填写。
        let Version: String = "7.0"

        /// 一个字符串，指定了 **PlaygroundBook** 使用的 Swift 语言版本。默认是 5.0。
        ///
        /// 可选填写
        var SwiftVersion: String = "5.1"

        /// 一个字符串，指定 **PlaygroundBook** 的最低运行的 Swift Playground App 版本。默认是 1.2 。
        ///
        /// 可选填写。
        var MinimumSwiftPlaygroundsVersion: String = "3.1"

        /// 一个字符串，用于确定用户对 **PlaygroundBook** 中用户可编辑模块的控制程度。
        ///
        ...
        /// 必须填写。
        ///
        /// > Tip: 这个属性从 Swift Playground 3 开始使用。
